...
public class Login extends JPanel {
	...
	private void criarComponentes() {
		...
		JLabel labelTitulo = new JLabel("Bem vindos ao Sistema da Company SA", JLabel.CENTER);
		...
		campoUsuario.setBounds(250,220,200,40);
	...
	private void criarEventos () {
		botaoEntrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//Valida credenciais
				if (campoUsuario.getText().equals("sa") && new String(campoSenha.getPassword()).equals("1867canada")) {
					Navegador.inicio();
				}else {
